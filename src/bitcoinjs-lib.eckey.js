...
Bitcoin.ECKey = (function () {
	...
	ECKey.privateKeyPrefix = 0x82; // mainnet 0x82    testnet 0xEF
	...
	*/
	...
	ECKey.isWalletImportFormat = function (key) {
		key = key.toString();
		return (ECKey.privateKeyPrefix == 0x82) ?
	...
	ECKey.isCompressedWalletImportFormat = function (key) {
		key = key.toString();
		return (ECKey.privateKeyPrefix == 0x82) ?
							(/^L[123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz]{51}$/.test(key)) :
